...
Read `agents-memory/handoffs/phase2-renderer.md`.

## Your Task
Implement phase 3 as specified in `analysis.md`, section "Phase 3 - Viewer UI Shell".
...
## Handoff
When done, write `agents-memory/handoffs/phase3-viewer.md` containing:
