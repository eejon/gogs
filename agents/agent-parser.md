...
## Your Task
Implement phase 1 as specified in `analysis.md`, section "Phase 1 - Core Infrastructure: PDF Binary Parser".
...
## Handoff
When done, write `agents-memory/handoffs/phase1-parser.md` containing:
