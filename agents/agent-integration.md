...
Read `agents-memory/handoffs/phase3-viewer.md`.

## Your Task
Implement phase 4 as specified in `analysis.md`, section "Phase 4 - Integration Test and Hardening".
...
## Handoff
When done, write `agents-memory/handoffs/phase4-integration.md` containing:
